...
- [2025.01.15 ~ 2025.11.28] SSAFY 13th Mobile Track 수료
- [2025.07.28 ~ 2025.08.22] SSAFY 공통프로젝트 "AI 기반 금형 탐지 시스템" (Molde) 구미 1반 1등🏆
    - Backend, IoT 담당
- [2025.09.01 ~ 2025.10.02] SSAFY 공통프로젝트 "대학생을 위한 성장형 뱅킹 앱 애플리케이션" (Mozzi)
    - Backend담당     
